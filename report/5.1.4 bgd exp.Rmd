...
rel_chg_cost <- round(((1 - (report_costs['final_costs'][1,] / report_costs['final_costs'][2,])) * 100),2)
rel_chg_time <- round(((1 - (report_costs['duration'][2,] / report_costs['duration'][1,] )) * 100),2)
```
...
params <- report %>% select(learning_rate, exp_decay, precision, maxiter, i_s) 
